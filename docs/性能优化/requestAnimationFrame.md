...
取消一个先前通过调用[`window.requestAnimationFrame()`](https://developer.mozilla.org/zh-CN/docs/Web/API/window/requestAnimationFrame)方法添加到计划中的动画帧请求。`cancelAnimationFrame`
